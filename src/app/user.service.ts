...
export class UserService {
  ...
  bookFlight(booking:{firstName:string;lastName:string;flightNo:string;pnr:string;age:number;mail:string;gender:string;mealType:string;
    seatNo:number;cost:number;bookingMail:string;},flightNo:string) {
